...
#pragma omp parallel for default(shared) shared(pop_size, stationary_distribution, nb_strategies_, nb_group_compositions_, group_size_, group_achievement_, Eigen::Dynamic) reduction(+ : group_achievement)
#endif
