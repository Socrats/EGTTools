...
/* Vendored from arpack-ng 3.9.1 (BSD-3-Clause).
 * Relative includes replaced with angle-bracket form so this header works
 * both as a vendored fallback (cpp/include as root) and as a system header.
 * arpackdef.h is always resolved from the installed arpack-ng package. */
