...
namespace egttools::FinitePopulations::structure {
    /**
     * @brief Synchronous network structure for N-player group games.
     *
     * Combines the group-fitness model of NetworkGroup<> with the
     * synchronous double-buffer update of NetworkSync<>.
     */
    ...
    template<class GameType, class CacheType>
    int NetworkGroupSync<GameType, CacheType>::population_size() { return population_size_; }

    template<class GameType, class CacheType>
    int NetworkGroupSync<GameType, CacheType>::nb_strategies() { return nb_strategies_; }

    template<class GameType, class CacheType>
    const AdjacencyList &NetworkGroupSync<GameType, CacheType>::network() { return network_; }

    template<class GameType, class CacheType>
    std::vector<int> NetworkGroupSync<GameType, CacheType>::population_strategies() const { return population_; }

    template<class GameType, class CacheType>
    VectorXui &NetworkGroupSync<GameType, CacheType>::mean_population_state() { return mean_population_state_; }

    template<class GameType, class CacheType>
    GameType &NetworkGroupSync<GameType, CacheType>::game() { return game_; }
